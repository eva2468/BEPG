...
var PaymentRoutes = func(router *mux.Router) {
	...
	router.HandleFunc("/complete_SIRegistration", controllers.Complete_SIRegistration).Methods("POST")
	router.HandleFunc("/deregister_SI", controllers.Deregister_SI).Methods("POST")
}
